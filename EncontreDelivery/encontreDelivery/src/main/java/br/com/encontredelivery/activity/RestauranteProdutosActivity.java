...
public class RestauranteProdutosActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handlerErros = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				erroAvisoDialog = new ErroAvisoDialog(RestauranteProdutosActivity.this);
		...
		handlerCarregarProdutos = new Handler() {
			@Override
			public void handleMessage(Message msg) {
				produtoAdapter = new ProdutoAdapter(RestauranteProdutosActivity.this, listaProdutos);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        new ListenerIcon(menuCarrinho, getString(R.string.carrinho)) {
            ...
            public void onClick(View v) {
				...
				Intent intent = new Intent(RestauranteProdutosActivity.this, CarrinhoActivity.class);
	...
	private OnItemClickListener clickLvProdutos() {
		OnItemClickListener clickLvProdutos = new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				extras.putSerializable("listaProdutosPedido", (ArrayList<ProdutoPedido>) listaProdutosPedido);
				Intent intent = new Intent(RestauranteProdutosActivity.this, ProdutosActivity.class);
				intent.putExtras(extras);
