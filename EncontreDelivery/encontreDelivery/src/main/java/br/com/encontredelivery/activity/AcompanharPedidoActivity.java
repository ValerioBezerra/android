...
public class AcompanharPedidoActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		llVazioStatus   = (LinearLayout) findViewById(R.id.llVazioStatus);
		...
		handlerCarregarStatus = new Handler() {
			@Override
			public void handleMessage(Message msg) {
				statusAdapter = new StatusAdapter(AcompanharPedidoActivity.this, listaStatus);
				lvStatus.setAdapter(statusAdapter);
				
				if (listaStatus.isEmpty()) {
					llVazioStatus.setVisibility(View.VISIBLE);
					lvStatus.setVisibility(View.GONE);
				} else {
					llVazioStatus.setVisibility(View.GONE);
